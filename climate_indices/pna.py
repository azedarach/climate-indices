...
def calculate_seasonal_eof(anom_data, season='DJF',
    ...
    eofs_data = eofs_result['eofs'][pna_mode][np.newaxis, ...]
    ...
    pcs_data = eofs_result['pcs'][:, pna_mode][:, np.newaxis]
    ...
    ev = eofs_result['explained_variance'][pna_mode]
    evr = eofs_result['explained_variance_ratio'][pna_mode]
    sv = eofs_result['singular_values'][pna_mode]
...
def calculate_pna_pc_index(anom_data, eofs_data,
