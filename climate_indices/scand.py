...
def calculate_seasonal_eof(anom_data, season='DJF',
    ...
    eofs_data = eofs_result['eofs'][scand_mode][np.newaxis, ...]
    ...
    pcs_data = eofs_result['pcs'][:, scand_mode][:, np.newaxis]
    ...
    ev = eofs_result['explained_variance'][scand_mode]
    evr = eofs_result['explained_variance_ratio'][scand_mode]
    sv = eofs_result['singular_values'][scand_mode]
...
def calculate_scand_pc_index(anom_data, eofs_data,
